  ...
  return [
...

    {
      ...
      metricNames: [
        ...
        'bcc.proc.io.net.http.saddr',
        'bcc.proc.io.net.http.sport',
        'bcc.proc.io.net.http.identifier',
        'bcc.proc.io.net.http.param',
        'bcc.proc.io.net.http.ws_upgrade',
      ],
      transforms: [
        onlyLatestValues(),
        renameMetric({
          ...
          'bcc.proc.io.net.http.sport': 'SRC PORT',
          'bcc.proc.io.net.http.saddr': 'SRC ADDR',
          'bcc.proc.io.net.http.identifier': 'METHODE/CODE',
          'bcc.proc.io.net.http.param': 'PARAM/MESSAGE',
          'bcc.proc.io.net.http.ws_upgrade': 'WEBSOCKET',
        }),
      ],
    },
